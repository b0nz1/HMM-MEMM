...
#gold_file ="dev"
#pred_file = "ner_memm-viterbi-predictions.txt"
...
if __name__ == '__main__':
    ...
    pred_data = [normalize_bio(tagged) for tagged in read_data(pred_file)][:-1]
    ...
    for t in types:
        ...
        f = prec*rec / (prec+rec)
        print("%10s \tPrec:%s Rec:%s F:%s" % (t, prec, rec, f))
